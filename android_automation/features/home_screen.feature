...
Feature: Tests for Home Screen functionality
    ...
    Scenario: User able to search existing Conversion types
    ...
    Scenario: User able to open calculator from options menu
        When I press on options icon
        Then I select "Calculator" from menu
        Then I see "Calculator" as a current unit converter
        And I press Close on calculator keyboard
